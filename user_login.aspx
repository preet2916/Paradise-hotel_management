<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_login.aspx.cs" Inherits="hotel_management.user_login" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form1" runat="server">
                        ...
                        <div class="input-group form-group">
                            ...
                            <asp:TextBox ID="txtaadhar_no" class="form-control input-1" placeholder="Aadhar No" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtaadhar_no" ErrorMessage="* aadhar number should have 12 digit" ForeColor="Red" ValidationExpression="^[0-9]{12}$" ValidationGroup="val"></asp:RegularExpressionValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtaadhar_no" ErrorMessage="* please enter your Aadhar No" ForeColor="Red" ValidationGroup="val"></asp:RequiredFieldValidator>
                ...
                <div class="card-footer">
                    <div class="d-flex links mb-3" style="justify-content: space-around;">
                        ...
                        <a href="admin_login.aspx">Admin Login <i class="fas fa-hand-point-right"></i></a>
                    </div>
                    <div class="d-flex justify-content-center">
