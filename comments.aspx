<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comments.aspx.cs" Inherits="hotel_management.comments" %>
                                ...
                                <ItemTemplate>
                                    <tbody id="myTable">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="name" runat="server" Text='<%# Eval("name") %>'></asp:Label></td>
                                            <td>
                                                <asp:Label ID="email" runat="server" Text='<%# Eval("email") %>'></asp:Label></td>
                                            <td>
                                                <asp:Label ID="comment" runat="server" Text='<%# Eval("comment") %>'></asp:Label></td>
                                            <td>
                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" OnClientClick="return confirm('Do you want to delete this Comment?');"
     ...
     <script>  
         function myFunction() {
             if (confirm("Do you want to log out") == true) {
                 ...
                 window.location.assign("comments.aspx");
             }
         }
     </script>
</body>
